        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview" id="mainOrdersNav">
                ...
                <ul class="treeview-menu">
                    ...
                    <li id="managepayment"><a href="{{route('sale.report')}}"><i class="fa fa-circle-o"></i>Sale
                            Report</a></li>

                    <li id="managepayment"><a href="{{route('purchase.report')}}"><i class="fa fa-circle-o"></i>Purchase
                            Report</a></li>
